...
export const servicePackages: ServicePackage[] = [
  { _id: 'package-interiors-01', line: 'interiors', numeral: '01', title: 'Consultation-Only Package', items: ['One-time meeting (in person or virtual) for advice, ideas, color selection, furniture arrangement, and general styling tips.'], price: '$500 per hour', image: images.flyerConsultation },
  { _id: 'package-interiors-02', line: 'interiors', numeral: '02', title: 'Full-Service Interior Design Package', items: ['End-to-end service, including concept development, space planning, furniture and décor selection, ordering, contractor coordination, and final styling.'], price: '$20,000 – $40,000', priceNote: 'Depending on square footage and design considerations.', image: images.flyerFullService },
  { _id: 'package-interiors-03', line: 'interiors', numeral: '03', title: 'E-Design Package', items: ['A remote design service where the designer provides a mood board, shopping list, floor plan, and styling tips. Clients handle purchases and execution.'], price: '$3,000 per room', image: images.flyerEDesign },
  { _id: 'package-interiors-04', line: 'interiors', numeral: '04', title: 'Turnkey Interior Design Package', items: ['A comprehensive package where the designer handles everything from start to finish, including purchasing, delivery, setup, and finishing touches. Ideal for luxury homes or high-end clients.'], price: '$50,000 – $250,000', priceNote: 'For an entire home, depending on square footage and design consideration.', image: images.flyerTurnkey },
  { _id: 'package-interiors-05', line: 'interiors', numeral: '05', title: 'Basic Room Design Package', items: ['Space planning, furniture selection, color palette, and styling recommendations. Does not include execution or full project management.'], price: '$5,000 per room', image: images.flyerBasicRoom },
