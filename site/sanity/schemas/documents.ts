...
export const servicePackage = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'image', title: 'Photograph', type: 'picture', description: 'Small portrait thumbnail beside the package. Leave empty for a "Photograph to come" frame.' }),
  ],
  orderings: [{ title: 'Menu order', name: 'menu', by: [{ field: 'line', direction: 'asc' }, { field: 'numeral', direction: 'asc' }] }],
  preview: {
    select: { title: 'title', numeral: 'numeral', price: 'price', line: 'line', media: 'image' },
    prepare: ({ title, numeral, price, line, media }) => ({ title: `${numeral} ${title}`, subtitle: `${line} · ${price}`, media }),
  },
});
...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'interiorsImage', title: 'Interiors photograph', type: 'picture', group: 'services', description: 'The large portrait plate beside the interiors menu.' }),
    ...
    defineField({ name: 'stylingImage', title: 'Styling photograph', type: 'picture', group: 'services', description: 'The large portrait plate beside the styling menu.' }),
...
export const inquiry = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'email', type: 'string' }),
    defineField({ name: 'phone', type: 'string' }),
    defineField({ name: 'city', title: 'City / neighbourhood', type: 'string' }),
    defineField({ name: 'service', title: 'Service', type: 'string' }),
    defineField({ name: 'projectType', title: 'Interiors — project type', type: 'string' }),
    defineField({ name: 'scope', title: 'Interiors — rooms / scope', type: 'text' }),
    defineField({ name: 'budget', title: 'Interiors — budget', type: 'string' }),
    defineField({ name: 'timeline', title: 'Timeline', type: 'string' }),
    defineField({ name: 'experience', title: 'Styling — experience', type: 'string' }),
    defineField({ name: 'goals', title: 'Styling — occasion / goals', type: 'text' }),
    defineField({ name: 'message', title: 'Message', type: 'text' }),
    defineField({ name: 'source', title: 'How they heard of us', type: 'string' }),
    defineField({ name: 'receivedAt', type: 'datetime' }),
  ],
  orderings: [{ title: 'Newest first', name: 'recent', by: [{ field: 'receivedAt', direction: 'desc' }] }],
  preview: {
    select: { title: 'name', subtitle: 'service', date: 'receivedAt' },
