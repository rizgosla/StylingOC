...
export const post = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'standfirst', type: 'string', group: 'story', description: 'One sentence under the headline, sentence case. Under 140 characters.', validation: (r) => r.required().max(140) }),
    ...
    defineField({ name: 'leadImage', title: 'Lead photograph', type: 'picture', group: 'story', description: 'Fills the right half of the opening spread. Leave empty to show a "Photograph to come" frame.' }),
